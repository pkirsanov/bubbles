...
assert_contains 'BEGIN TRANSITION_GUARD_RESULT_V2' 'baseline reaches structured result start'
...
assert_contains 'END TRANSITION_GUARD_RESULT_V2' 'compound matrix reaches a normal structured result'
