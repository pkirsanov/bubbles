...
- Gates defined: **112**
- Declared mechanically enforced (`guard-check:` / `script:` / `ci:`): **73**
- Declared `mode-required` only (a mode requires it; no dedicated mechanical enforcer): **36**
...
| --- | --- | --- | --- | --- | --- | --- |
| G001 | artifact_gate | `mode-required` | 55 | — | 6 | — |
| G002 | scope_definition_gate | `mode-required` | 23 | — | 2 | — |
| G003 | test_integrity_gate | `mode-required` | 25 | — | 2 | — |
| G004 | test_execution_gate | `mode-required` | 25 | — | 1 | — |
| G005 | evidence_gate | `mode-required` | 25 | — | 1 | — |
| G006 | docs_sync_gate | `mode-required` | 46 | — | — | — |
| G007 | validation_gate | `mode-required` | 48 | — | — | — |
| G008 | audit_gate | `mode-required` | 42 | — | — | — |
| G009 | chaos_gate | `mode-required` | 26 | — | 1 | — |
| G010 | user_validation_gate | `mode-required` | 31 | — | — | — |
...
| G021 | anti_fabrication_gate | `guard-check:12` | 25 | Check 20 | 4 | guard |
...
| G034 | security_gate | `mode-required` | 22 | — | — | — |
...
| G042 | artifact_ownership_enforcement_gate | `guard-check:3G` | 0 | Check 3G | 1 | guard |
...
| G095 | discovered_issue_disposition_gate | `script:bubbles/scripts/discovered-issue-disposition-guard-selftest.sh`, `script:bubbles/scripts/discovered-issue-disposition-guard.sh` | 0 | Check 35 | 6 | guard |
...
| G100 | observability_slo_evidence_gate | `script:bubbles/scripts/observability-slo-guard-selftest.sh`, `script:bubbles/scripts/observability-slo-guard.sh` | 0 | Check 39 | 5 | guard |
...
| G110 | release_train_discipline_gate | `script:bubbles/scripts/release-train-guard.sh` | 8 | — | 1 | — |
...
| G125 | framework_health_evidence_gate | `script:bubbles/scripts/framework-health-evidence-lint.sh`, `script:bubbles/scripts/retro-framework-health.sh` | 1 | — | 2 | — |
...
| G131 | domain_model_consistency_gate | `script:bubbles/scripts/claim-source-lint.sh`, `script:bubbles/scripts/domain-model-consistency-selftest.sh`, `script:bubbles/scripts/domain-model-consistency.sh` | 0 | Check 42 | 3 | guard |
