...
VALID_AUTONOMY="full guarded interactive"
...
usage() {
  cat <<'EOF'
Usage: bash bubbles/scripts/autonomy-resolve.sh [--autonomy <v>] [--directive "<str>"] [--repo-root <dir>] [--format env|json]
...
Options:
  --autonomy <full|guarded|interactive>
