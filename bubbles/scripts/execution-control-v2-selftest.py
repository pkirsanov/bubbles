...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        check(verification["localConsistency"] is True and verification["anchorStatus"] == "not-provided", "SEC-ECF-10 local verification does not claim rollback resistance")
        ...
        check(anchored["anchorStatus"] == "verified", "SEC-ECF-10 matching caller-retained checkpoint verifies")
