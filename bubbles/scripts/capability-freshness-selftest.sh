...
rewrite_once "$TMP_ROOT/docs/generated/competitive-capabilities.md" 'State summary: 19 shipped, 1 partial, 0 proposed.' 'State summary: 2 shipped, 1 partial, 4 proposed.'
