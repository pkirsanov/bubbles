...
check_pattern "$ROOT_DIR/docs/generated/competitive-capabilities.md" '^State summary: 19 shipped, 1 partial, 0 proposed\.$' "Generated capability guide exposes stable state summary"
