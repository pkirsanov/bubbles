...
# =============================================================================
# Analyzes the project codebase and generates/updates the `scans` section
# in .github/bubbles-project.yaml with project-appropriate patterns.
#
...
#   - If it exists but has no scans section: appends scans section
...
# =============================================================================
# Project-specific scan pattern extensions for Bubbles quality gates.
...
log ""
log "Customize: edit .github/bubbles-project.yaml to add project-specific patterns or custom gates."
