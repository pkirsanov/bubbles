...
check_pattern "$ROOT_DIR/docs/generated/competitive-capabilities.md" '^State summary: 3 shipped, 1 partial, 2 proposed\.$' "Generated capability guide exposes stable state summary"
