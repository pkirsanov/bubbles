...
cmd_doctor() {
  ...
  if [[ -n "$current_profile" ]]; then
    echo -e "  ${GREEN}✅${NC} Active adoption profile: ${current_profile}"
  else
    echo -e "  ${CYAN}ℹ️${NC}  No explicit adoption profile recorded yet; current installs remain delivery-oriented."
  fi
