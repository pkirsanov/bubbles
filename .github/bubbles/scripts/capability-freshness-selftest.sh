...
rewrite_once "$TMP_ROOT/docs/generated/competitive-capabilities.md" 'State summary: 3 shipped, 1 partial, 2 proposed.' 'State summary: 2 shipped, 1 partial, 3 proposed.'
