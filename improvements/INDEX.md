...
| [IMP-032](IMP-032-status-mirror-invariant-and-underclaim-detection.md) | Status-mirror invariant: name it, explain it at failure time, and give it a legal repair path | PROPOSED — retained after v7.22 rollback; no scopes applied | framework-health (G125) | EV-4, COV-4, DOC-4, REG-5 | 2026-08-02 |

> **Numbering note:** IMP-001…IMP-028, IMP-032, and IMP-100…IMP-107 are already referenced
> across `bubbles/scripts/**`, `docs/**`, and `CHANGELOG.md` as historical
> delivery identifiers. IMP-029 through IMP-031 remain reserved; IMP-030 and
> IMP-031 identify the rolled-back v7.22 work. New proposals continue from
> **IMP-033** in the primary
> band. Verify with:
