...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/workflow_modes-52-bc8cff?style=flat-square" alt="52 modes">
...
<tr><td width="64"><img src="icons/julian-glass.svg" width="48"></td><td><strong>52 workflow modes</strong> — from full delivery to quick bugfixes to chaos sweeps</td></tr>
...
├── bubbles/
│   ├── workflows.yaml               # 52 workflow mode definitions
...
Bubbles supports 52 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 52 modes.
...
<tr><td><a href="docs/guides/WORKFLOW_MODES.md">Workflow Modes</a></td><td>All 52 workflow modes explained</td></tr>
