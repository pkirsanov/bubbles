...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/gates-97-3fb950?style=flat-square" alt="97 gates">
  <img src="https://img.shields.io/badge/workflow_modes-54-bc8cff?style=flat-square" alt="54 modes">
...
<tr><td width="64"><img src="icons/lahey-badge.svg" width="48"></td><td><strong>97 quality gates</strong> — nothing ships without evidence. Nothing.</td></tr>
<tr><td width="64"><img src="icons/julian-glass.svg" width="48"></td><td><strong>54 workflow modes</strong> — from full delivery to quick bugfixes to chaos sweeps</td></tr>
...
├── bubbles/
│   ├── workflows.yaml               # 54 workflow mode definitions
...
Bubbles supports 54 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 54 modes.
...
<tr><td><a href="docs/guides/WORKFLOW_MODES.md">Workflow Modes</a></td><td>All 54 workflow modes explained</td></tr>
