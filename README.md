...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/agents-39-58a6ff?style=flat-square" alt="39 agents">
  <img src="https://img.shields.io/badge/gates-93-3fb950?style=flat-square" alt="93 gates">
  <img src="https://img.shields.io/badge/workflow_modes-49-bc8cff?style=flat-square" alt="49 modes">
...
<tr><td width="64"><img src="icons/bubbles-glasses.svg" width="48"></td><td><strong>39 specialized agents</strong> — each with a defined role, from implementation to framework ops</td></tr>
<tr><td width="64"><img src="icons/lahey-badge.svg" width="48"></td><td><strong>93 quality gates</strong> — nothing ships without evidence. Nothing.</td></tr>
<tr><td width="64"><img src="icons/julian-glass.svg" width="48"></td><td><strong>49 workflow modes</strong> — from full delivery to quick bugfixes to chaos sweeps</td></tr>
...
│   ├── bubbles.workflow.agent.md    # 39 agent definitions
...
│       └── ...
├── prompts/
│   └── bubbles.*.prompt.md          # 39 prompt shims
├── bubbles/
│   ├── workflows.yaml               # 49 workflow mode definitions
...
Bubbles supports 49 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 49 modes.
...
<tr><td><a href="docs/guides/WORKFLOW_MODES.md">Workflow Modes</a></td><td>All 49 workflow modes explained</td></tr>
