...
│   ├── bubbles.workflow.agent.md    # 30 agent definitions
...
- `grillFirst: true` pressure-tests the direction before planning or implementation starts.
