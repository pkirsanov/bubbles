...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/gates-96-3fb950?style=flat-square" alt="96 gates">
  <img src="https://img.shields.io/badge/workflow_modes-53-bc8cff?style=flat-square" alt="53 modes">
...
<tr><td width="64"><img src="icons/lahey-badge.svg" width="48"></td><td><strong>96 quality gates</strong> — nothing ships without evidence. Nothing.</td></tr>
<tr><td width="64"><img src="icons/julian-glass.svg" width="48"></td><td><strong>53 workflow modes</strong> — from full delivery to quick bugfixes to chaos sweeps</td></tr>
...
├── bubbles/
│   ├── workflows.yaml               # 53 workflow mode definitions
...
Bubbles supports 53 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 53 modes.
...
<tr><td><a href="docs/guides/WORKFLOW_MODES.md">Workflow Modes</a></td><td>All 53 workflow modes explained</td></tr>
