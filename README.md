...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/gates-68-3fb950?style=flat-square" alt="68 gates">
...
<tr><td width="64"><img src="icons/lahey-badge.svg" width="48"></td><td><strong>68 quality gates</strong> — nothing ships without evidence. Nothing.</td></tr>
...
├── bubbles/
│   ├── workflows.yaml               # 35 workflow mode definitions
...
Bubbles supports 35 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 35 modes.
