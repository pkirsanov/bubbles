...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/gates-101-3fb950?style=flat-square" alt="101 gates">
  <img src="https://img.shields.io/badge/workflow_modes-55-bc8cff?style=flat-square" alt="55 modes">
...
<tr><td width="64"><img src="icons/lahey-badge.svg" width="48"></td><td><strong>101 quality gates</strong> — nothing ships without evidence. Nothing.</td></tr>
<tr><td width="64"><img src="icons/julian-glass.svg" width="48"></td><td><strong>55 workflow modes</strong> — from full delivery to quick bugfixes to chaos sweeps</td></tr>
...
├── bubbles/
│   ├── workflows.yaml               # 55 workflow mode definitions
...
Bubbles supports 55 workflow modes plus optional execution tags. Here are the most common:
...
See [docs/guides/WORKFLOW_MODES.md](docs/guides/WORKFLOW_MODES.md) for all 55 modes.
...
<tr><td><a href="docs/generated/competitive-capabilities.md">Competitive Capabilities</a></td><td>Ledger-backed competitive posture guide — 17 shipped, 1 partial, 0 proposed</td></tr>
...
<tr><td><a href="docs/guides/WORKFLOW_MODES.md">Workflow Modes</a></td><td>All 55 workflow modes explained</td></tr>
